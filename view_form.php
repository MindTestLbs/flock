...
$pageTitle = "View Form";
$pageName = "view_form.php";
$smarty->assign('pageName',$pageName);
$smarty->assign('pageTitle',$pageTitle);

$form_id 							= base64_decode(base64_decode($_REQUEST['form_id']));
$qrapp='<input type="hidden" name="form_id" value="'.$_REQUEST['form_id'].'">';
...
if($cnt>0)
{
	...
	$FormcustomFields 		= $dbClass->getTableRecordDetails("form_custom_fields","form_id=?",array($form_id));
