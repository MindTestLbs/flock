...
if($numRows >0)
{
	...
	$pager 				= new SqlPager($query,$numRows,$conditionValues,$url->urlBase."createtemplates.php?$urlParam",$items_per_page,$dbDetails);	
...
$smarty->display('createtemplates.tpl');
?>