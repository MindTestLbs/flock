	...
	function encryptPaswd($string, $key) 
	{
                ...
                function GeturlContents($url='')
		{
			...
			return array($pageData, true);
                ...
                function getFilePic($file,$extn)
                {
                    global $configDetails;
                    $extn = strtolower($extn);
                    if($extn=='gif' || $extn=='png' || $extn=='jpg' || $extn=='ico')
                    {
                        return $configDetails['siteUrl'].$file;
                    }
                    else
                    {
                        return $configDetails['siteUrl'].$configDetails['user_files']."default-doc.png";
                    }
                }
