...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
		<title>{$metaDetails.page_title}</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="stylesheet" href="{$url->urlBase}css/bootstrap.min.css">

        <link rel="stylesheet" href="{$url->urlBase}css/bootstrap-theme.min.css">
        
        
        <!-- Owl Carousel Assets -->
        <link href="{$url->urlBase}css/owl.carousel.css" rel="stylesheet">
        
        <!-- dont use -->
        <link href="{$url->urlBase}css/owl.theme.css" rel="stylesheet">
        <!-- dont use -->
        <link href="{$url->urlBase}css/owl.transitions.css" rel="stylesheet">
        
		<!-- fancy box -->
		<link href="{$url->urlBase}css/jquery.fancybox.css" rel="stylesheet" >
		
		<link href="{$url->urlBase}css/main.css" rel="stylesheet" >
        <script src="{$url->urlBase}js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="top-line"></div>
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand logo" href="#top-section"><img src="{$url->urlBase}img/logo.png" class="img-responsive" alt="logo"></a>
        </div>
                    	...
                    	<div class="row">
                            ...
                            <div class="col-sm-5 pull-right ">
                                <div class="slide-right">
									...
									<form name="getstform" method="post" action="{$url->urlBase}register.php">
                            ...
                            <div class="col-sm-8 col-xs-offset-2">
                                <div id="slide">
                                    <div id="owl-slide" class="owl-carousel owl-theme">
                                      <div class="item"><img src="{$url->urlBase}img/1.jpg"></div>
                                      <div class="item"><img src="{$url->urlBase}img/2.jpg"></div>
                                      <div class="item"><img src="{$url->urlBase}img/3.jpg"></div>
                                      <div class="item"><img src="{$url->urlBase}img/4.jpg"></div>
                                      <div class="item"><img src="{$url->urlBase}img/5.jpg"></div>
                                      <div class="item"><img src="{$url->urlBase}img/6.jpg"></div>
                                      <div class="item"><img src="{$url->urlBase}img/7.jpg"></div>
                                    </div>
                                </div>
                            </div> 
                        </div> 
    	...
    	<div class="content-co2">
			...
			<div class="overlaybase">
    			...
    			<div class="galery-item">
    				<div class="col-xs-2">
    					<div class="gla-thumb">
    						<a href="{$url->urlBase}img/gallery-t1.png" rel="gallery-1" class="img-th">
                            	<div class="hover">
                                	<img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom">
                                </div><!-- hover -->
                                <div class="thumb">
                                	<img src="{$url->urlBase}img/gallery-t1.png" class="img-responsive" alt="1">
                                </div>
    						</a>   						
						</div><!-- gla-thumb -->
    				</div><!-- col-xs-2 -->
					<div class="col-xs-2">
						<div class="gla-thumb">
							<a href="{$url->urlBase}img/gallery-t2.png" class="img-th" rel="gallery-1">
								<div class="hover">
									<img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom">
								</div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t2.png" class="img-responsive" alt="1">
								</div>
							</a>							
						</div><!-- gla-thumb -->
					</div><!-- col-xs-2 -->
					<div class="col-xs-2">
						<div class="gla-thumb">					
							<a href="{$url->urlBase}img/gallery-t3.png" class="img-th" rel="gallery-1">
								<div class="hover">
									<img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom">
								</div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t3.png" class="img-responsive" alt="1">
								</div>
							</a>							
						</div><!-- gla-thumb -->  
					</div><!-- col-xs-2 -->
					<div class="col-xs-2">
						<div class="gla-thumb">  
							<a href="{$url->urlBase}img/gallery-t4.png" class="img-th" rel="gallery-1">
								<div class="hover">
									<img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom">
								</div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t4.png" class="img-responsive" alt="1">
								</div>
							</a>							
						<!-- gla-thumb -->					
						</div><!-- col-xs-2 -->
					...
					<div class="col-xs-2">
						<div class="gla-thumb">
							<a href="{$url->urlBase}img/gallery-t5.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t5.png" class="img-responsive" alt="1">
								</div>
					...
					<div class="col-xs-2">
						<div class="gla-thumb">				
							<a href="{$url->urlBase}img/gallery-t6.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t6.png" class="img-responsive" alt="1">
								</div>
							</a>							
						</div><!-- gla-thumb -->
					...
					<div class="col-xs-2">
						<div class="gla-thumb">					
							<a href="{$url->urlBase}img/gallery-t7.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t7.png" class="img-responsive" alt="1">
								</div>
							</a>							
						</div><!-- gla-thumb -->
					</div><!-- col-xs-2 -->
					<div class="col-xs-2">
						<div class="gla-thumb">					
							<a href="{$url->urlBase}img/gallery-t8.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t8.png" class="img-responsive" alt="1">
								</div>
							</a>							
						</div><!-- gla-thumb -->
					</div><!-- col-xs-2 -->
					<div class="col-xs-2">
						<div class="gla-thumb">				
							<a href="#" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t9.png" class="img-responsive" alt="1">
								</div>
							</a>					
						</div><!-- gla-thumb -->
					...
					<div class="col-xs-2">
						<div class="gla-thumb">				
							<a href="{$url->urlBase}img/gallery-t10.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t10.png" class="img-responsive" alt="1">
								</div>
							</a>							
						</div><!-- gla-thumb -->
					...
					<div class="col-xs-2">
						<div class="gla-thumb">					
							<a href="{$url->urlBase}img/gallery-t11.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t11.png" class="img-responsive" alt="1">
								</div>
							</a>
						</div><!-- gla-thumb -->
					...
					<div class="col-xs-2">
						<div class="gla-thumb">					
							<a href="{$url->urlBase}img/gallery-t12.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t12.png" class="img-responsive" alt="1">
								</div>
							</a>
						</div><!-- gla-thumb -->
					</div><!-- col-xs-2 -->
				...
				<div class="galery-item">
    				<div class="col-xs-2">
    					<div class="gla-thumb">
    						<a href="{$url->urlBase}img/gallery-t1.png" class="img-th" rel="gallery-1">
                            	<div class="hover">
                                	<img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom">
                                </div><!-- hover -->
                                <div class="thumb">
					...
					<div class="col-xs-2">
						<div class="gla-thumb">
							...
							<a href="{$url->urlBase}img/gallery-t9.png" class="img-th" rel="gallery-1">
								<div class="hover"><img src="{$url->urlBase}img/zoom.png" class=" img-responsive" alt="zoom"></div><!-- hover -->
								<div class="thumb">
									<img src="{$url->urlBase}img/gallery-t9.png" class="img-responsive" alt="1">
								</div>
...
<section id="Section-3">
						...
						{foreach $packages as $item}
                            ...
                            <div class="price">
                                <div class="price-top">
									...
									<form name="getstform{$item.package_setting_id|stripslashes}" method="post" action="{$url->urlBase}register.php">
                            ...
                            <div id="owl-slide3" class="owl-carousel owl-theme">
                              ...
                              <div class="item">
                                <div class="col-sm-3 col-xs-offset-1">
                                    ...
                                    <div class="testi-img-in">
                                            <img src="{$url->urlBase}img/test2.png" class="img-responsive" alt="testi1">
                                    </div><!-- testi-img-in -->
                                </div><!-- col-sm-3 -->
                              ...
                              <div class="item">
                                <div class="col-sm-3 col-xs-offset-1">
                                    ...
                                    <div class="testi-img-in">
                                            <img src="{$url->urlBase}img/test1.png" class="img-responsive" alt="testi1">
                                    </div><!-- testi-img-in -->
                                </div><!-- col-sm-3 -->
							  ...
							  <div class="item">
                                <div class="col-sm-3 col-xs-offset-1">
                                    ...
                                    <div class="testi-img-in">
                                            <img src="{$url->urlBase}img/test3.png" class="img-responsive" alt="testi1">
                                    </div><!-- testi-img-in -->
                                </div><!-- col-sm-3 -->
        	...
        	<div class="container">
            	<div class="row">
                    <div class="col-sm-6 con-left">
                        <div class="ft-logo"><img src="{$url->urlBase}img/ft-logo.png" alt="ft-logo"></div>
                            <div class="address">
                                <img src="{$url->urlBase}img/address-icon.png" width="71" height="71" alt="address">
                        ...
                        <div class="address2">
                            <img src="{$url->urlBase}img/call-icon.png" width="71" height="71" alt="call">
                        ...
                        <div class="address2">
                            <img src="{$url->urlBase}img/mail-icon.png" width="71" height="71" alt="call">
	...
	<!-- / FOOTER -->
        ...
        <script src="{$url->urlBase}js/vendor/jquery-1.11.0.min.js"></script>
        ...
        <script src="{$url->urlBase}js/owl.carousel.min.js"></script>
        <script src="{$url->urlBase}js/jquery.tools.min.js"></script>
 		<script src="{$url->urlBase}js/jquery.fancybox.js"></script>
		 <script src="{$url->urlBase}js/jquery.uniform.js"></script>
		
 		<script src="{$url->urlBase}js/homemain.js"></script>
		<script src="{$url->urlBase}js/plugins.js"></script>
