                    ...
                    <div class="sd-form-1">
                    	<div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                	<input type="text" class="form-control commen-text-feild" name="form_name" id="form_name" value="{$smarty.request.form_name|stripslashes}"  data-validation="required">
                                </div><!-- cm-sl-mode -->
                                <span class="smallipop cs-tooltip">
                                    <span class="smallipop-hint">
                            ...
                            <div class="col-md-8">
                            	<div class="commen-check">
                                	<label>
                                		<input name="require_confirm" type="checkbox" value="1" {if $smarty.request.require_confirm=='1'} checked="checked" {/if} class="cm-checkbox">
                            ...
                            <div class="col-md-8">
                            	<div class="commen-check">
                                	<label>
                                		<input name="send_thankyoumail" type="checkbox" value="1" {if $smarty.request.send_thankyoumail=='1'} checked="checked" {/if} class="cm-checkbox"/>
                    ...
                    <div class="sd-form-1">
                    	<div class="row">
                        	<div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                	 <input type="text" class="form-control commen-text-feild" id="full-popoverback" name="design_color" size="7" maxlength="7" value="{$smarty.request.design_color}" data-color-format="hex">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                	<input type="text" class="form-control commen-text-feild" id="full-popoverletter" name="letter_color" size="7" maxlength="7" value="{$smarty.request.letter_color}" data-color-format="hex">
                                </div><!-- cm-sl-mode -->
								<script>
                            ...
                            <div class="col-md-8">
                            	<div class="commen-check">
                                	<label>
                                		<input name="use_captcha" type="checkbox" value="1" {if $smarty.request.use_captcha=='1'} checked="checked" {/if} class="cm-checkbox"/>
                        	...
                        	<div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                 <div class="ffs-scroll">
                                            ...
                                            <li>
											<div class="commen-check">
                                			<label><input  name="contctarr[]" type="checkbox" class="cm-checkbox" value="{$item.list_id}" {if in_array($listid, $contctarr)} checked="checked" {/if}>{$item.list_name|stripslashes}</label>
											</div>
											</li>
											{/foreach}
											{/if}
