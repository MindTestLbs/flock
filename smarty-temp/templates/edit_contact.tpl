    ...
    <section class="commen-base">
		...
		<div class="right-panel">
        	<div class="container-fluid">
				...
				<form name="addcontactfrm" id="addcontactfrm" method="post" action="{$url->urlBase}edit_contact.php">
                <div class="send-email-base">
					...
					<input type="hidden" name="SubscriberId" value="{$smarty.request.SubscriberId}">
