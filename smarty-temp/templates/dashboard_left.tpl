<div class="flock-sidebar second-sidebar"><!--Add to  this class "second-sidebar" to change the sidebar style -->
            ...
            <div class="sidebar-nav">
            	...
            	<ul>
                    ...
                    <li {if $pageName == 'list_forms.php' ||  $pageName == 'create_form.php' ||  $pageName == 'view_form.php' ||  $pageName == 'edit_form.php' ||  $pageName == 'show_formcode.php' ||  $pageName == 'edit_arrange_customfield.php'} class="active" {/if}>
                        ...
                        <ul>
                        	...
                        	<li {if $pageName == 'list_forms.php' } class="active" {/if}><a href="{$url->urlBase}list_forms.php">Website Forms</a></li>

                            <li {if $pageName == 'create_form.php'} class="active" {/if}><a href="{$url->urlBase}create_form.php">Create New Form</a></li>
