<?php /* Smarty version Smarty-3.1.19, created on 2015-12-07 17:14:39
         compiled from "/var/www/flockmails-refined/smarty-temp/templates/custom_templates.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73686365756657127e823c9-53696447%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '817df21b33337a409c60d7cbc6767887f2089076' => 
    array (
      0 => '/var/www/flockmails-refined/smarty-temp/templates/custom_templates.tpl',
      1 => 1449223725,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73686365756657127e823c9-53696447',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56657127efae42_71407498',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56657127efae42_71407498')) {function content_56657127efae42_71407498($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_stripslashes')) include '/var/www/flockmails-refined/Smarty/libs/plugins/modifier.stripslashes.php';
?><!DOCTYPE html>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">
                                            <div class="tbr-first tbr-height">
                                                <h5><?php echo smarty_modifier_stripslashes($_smarty_tpl->tpl_vars['item']->value['template_name']);?>
</h5>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="tbr-second tbr-height">
                                                <p><?php echo $_smarty_tpl->tpl_vars['item']->value['template_created_date'];?>
</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-2">
                                            <div class="tbr-second tbr-height">
                                                <p><?php if ($_smarty_tpl->tpl_vars['item']->value['template_format']=='h') {?>
															HTML
														<?php } elseif ($_smarty_tpl->tpl_vars['item']->value['template_format']=='ht') {?>
															HTML & Text
															<?php } else { ?>
															Text
															<?php }?></p>
