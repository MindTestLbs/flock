<?php /* Smarty version Smarty-3.1.19, created on 2015-12-15 15:45:47
         compiled from "/var/www/flock/smarty-temp/templates/edit_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:424668296566fe853ac09c3-24924287%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cdf647bc919f994b59fd6c403ade7ce8f258b9c' => 
    array (
      0 => '/var/www/flock/smarty-temp/templates/edit_form.tpl',
      1 => 1450162960,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '424668296566fe853ac09c3-24924287',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_566fe853bd6e45_24426655',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_566fe853bd6e45_24426655')) {function content_566fe853bd6e45_24426655($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_stripslashes')) include '/var/www/flock/Smarty/libs/plugins/modifier.stripslashes.php';
?><!DOCTYPE html>
                    ...
                    <div class="sd-form-1">
                    	<div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                	<input type="text" class="form-control commen-text-feild" name="form_name" id="form_name" value="<?php echo smarty_modifier_stripslashes($_REQUEST['form_name']);?>
"  data-validation="required">
                            ...
                            <div class="col-md-8">
                            	<div class="commen-check">
                                	<label>
                                		<input name="require_confirm" type="checkbox" value="1" <?php if ($_REQUEST['require_confirm']=='1') {?> checked="checked" <?php }?> class="cm-checkbox">
                            ...
                            <div class="col-md-8">
                            	<div class="commen-check">
                                	<label>
                                		<input name="send_thankyoumail" type="checkbox" value="1" <?php if ($_REQUEST['send_thankyoumail']=='1') {?> checked="checked" <?php }?> class="cm-checkbox"/>
                    ...
                    <div class="sd-form-1">
                    	<div class="row">
                        	<div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                	 <input type="text" class="form-control commen-text-feild" id="full-popoverback" name="design_color" size="7" maxlength="7" value="<?php echo $_REQUEST['design_color'];?>
" data-color-format="hex">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="cm-sl-mode">
                                	<input type="text" class="form-control commen-text-feild" id="full-popoverletter" name="letter_color" size="7" maxlength="7" value="<?php echo $_REQUEST['letter_color'];?>
" data-color-format="hex">
                                </div><!-- cm-sl-mode -->
								<script>
                            ...
                            <div class="col-md-8">
                            	<div class="commen-check">
                                	<label>
                                		<input name="use_captcha" type="checkbox" value="1" <?php if ($_REQUEST['use_captcha']=='1') {?> checked="checked" <?php }?> class="cm-checkbox"/>
...
?>
											<?php $_smarty_tpl->tpl_vars['listid'] = new Smarty_variable($_smarty_tpl->tpl_vars['item']->value['list_id'], null, 0);?>
											
                                            <li>
											<div class="commen-check">
                                			<label><input  name="contctarr[]" type="checkbox" class="cm-checkbox" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['list_id'];?>
" <?php if (in_array($_smarty_tpl->tpl_vars['listid']->value,$_smarty_tpl->tpl_vars['contctarr']->value)) {?> checked="checked" <?php }?>><?php echo smarty_modifier_stripslashes($_smarty_tpl->tpl_vars['item']->value['list_name']);?>
</label>
											</div>
											</li>
											<?php } ?>
