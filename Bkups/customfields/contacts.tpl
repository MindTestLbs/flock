												...
												<div class="row">
													...
													<div class="col-lg-3">
														<div class="cc-button-div">
															...
															<a href="{$url->urlBase}contactlist_contacts.php?action=delete&delid={$item.subscriber_id|base64_encode}&list_id={$smarty.request.list_id}" onClick="return confirm('Are you sure, you want to delete this list?')" class="bt-delete"></a>
														  </div>
													</div>
												</div>
											</li>
