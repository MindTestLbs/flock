        	...
        	<div class="container-fluid">
                ...
                <div class="send-email-base">
					...
					<div class="sd-form-1">
                    	<div class="row">
                        	<div class="col-md-12">
                            	<label class="form-label">Add These Fields to the List:</label>
                                <div class="cm-sl-mode">
                                	<div style="float:left; height:140px; overflow:scroll;width:50%; padding-bottom:3px;">
                     			
									{foreach $customFields as $item}
									<input type="checkbox" name="custom_fields[]"  value="{$item.customfield_id}" {if $item.customfield_id|in_array:$contactCustomArr}   checked="checked" {/if}>&nbsp;{$item.customfield_name|stripslashes}<br />
									{/foreach}						
					...
					<h3 class="commen-h3">COMPANY DETAILS</h3>
                    <div class="sd-form-1">
                    	<div class="row">
                        	<div class="col-md-6">
