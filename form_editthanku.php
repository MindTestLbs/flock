...
$pageTitle = "Update Website Form - Thank You Page";
...
if(isset($_REQUEST['submit']) && $_REQUEST['submit']=="Submit")
{
	...
	$errorFlag=0;
		...
		$dbClass->prepareUpdateStatement("form_page", $updateInfo, 'form_id=? AND page_type=?',array($formId,'thankyou'));
...
{
$confirmPageInfo=  $dbClass->getTableRecordSingle("form_page","form_id=? AND page_type=?",array($formId,'thankyou'));
...
$smarty->display('form_editthanku.tpl');
